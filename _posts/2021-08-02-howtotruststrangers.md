...
<!-- Hence, o (In our work, we present three composition methods of increasing suitability. The most comprehensive and practically relevant composition rule is the following, which we call _Cartesian composition_.
...
The fail-prone systems are _F1 = { {a}, {b,c}, {d}, {c,e} }_ and _F2 = { {d}, {e}, {f,g}, {h} }_, respectively.

![Two BQS with common processes](/images/strangers/sym-original-systems.png){: width="37%" .center-image}
...
A first thought would be to define the new, composite fail-prone system as the union of the two original ones. The result would look like the following figure.
...
![Symmetric composition, cartesian rule](/images/strangers/sym-cartesian-rule.png){: width="37%" .center-image}
...
![Symmetric composition, the problem with cartesian rule](/images/strangers/sym-cartesian-problem.png){: width="37%" .center-image}
...
![Symmetric composition, the correct cartesian rule](/images/strangers/sym-cartesian2-rule.png){: width="37%" .center-image}

This results in a fail-prone system _F3_ as shown in the next figure.

![Symmetric composition, the result of the correct cartesian rule](/images/strangers/sym-cartesian2-result.png){: width="37%" .center-image}
...
![Example of ABQS composition](/images/strangers/composition_asymmetric.png){: width="80%" .center-image}
...
![The tolerated systems in our example](/images/strangers/asym-tolerated.png){: width="37%" .center-image}

#### Applying the cartesian rule
We are now ready to perform the composition of our two ABQS. The idea is that every process in _P1_ uses the cartesian composition (with the special handling for common processes) between its fail-prone system and _T2_, and vice cersa for processes in _P2_. In the next picture we show, for example, how process _c_ would do the composition.

![The asymmetric composition rule in our example](/images/strangers/asym-rule.png){: width="37%" .center-image}
